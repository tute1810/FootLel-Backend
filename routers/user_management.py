...
def edit_user_info(user_info: user_info.UserInfo):
    if user_info.user_name != "" and authentication.is_user_name_available(user_info.user_name) == False:
    ...
    if user_info.user_email != "" and authentication.is_user_email_available(user_info.user_email) == False:
